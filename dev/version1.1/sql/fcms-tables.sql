...
INSERT INTO component VALUES (2,1,1,1,1,2003,0,'content','Access:','1','FFFFFF','000000','times','center',2);
INSERT INTO component VALUES (3,1,1,1,2,2003,0,'content','','1','FFFFFF','000000','times','center',2);
...
INSERT INTO content_component VALUES (2,1,1,1,2,1,'<form action=index.php METHOD=POST> <input type=text name=f_user value= size=40>\r\n<input type=password name=f_pass value= size=40>\r\n<input type=submit value=Login><input type=reset> <input type=hidden name=host_id value=1><input type=hidden name=site_id value=1><input type=hidden name=page_id value=1><input type=hidden name=referp_id value=><input type=hidden name=component_id value=><input type=hidden name=mode value=authorize><input type=hidden name=action value=login></form>','1','0','0','times','center',NULL,NULL,NULL,NULL,2);
INSERT INTO content_component VALUES (3,1,1,1,3,2,'<img src=http://127.0.0.1/~parasyte/fcms/images/logo.gif >\r\n','1','0','0','times','center',NULL,NULL,NULL,NULL,2);
...
INSERT INTO users VALUES (1,1,1,'fcms_host','passwd',1049508345,NULL,NULL,NULL,NULL,NULL,NULL,0,'305e2fcc21e189a1d51dd1ddd59d189e',14);
